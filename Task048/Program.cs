...
// в массиве находится по формуле: Amn = m+n. Выведите полученный
// массив на экран.  m = 3, n = 4.      0 1 2 3
//                                      1 2 3 4
//                                      2 3 4 5

// Метод создания двухмерного массива
int[,] CreateMatrixSumCoordinate(int rows, int columns) 
{     
...
int [,] array2D = CreateMatrixSumCoordinate(3, 4);
PrintMatrix(array2D);